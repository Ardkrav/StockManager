        ...
        <div class="card w-50 shadow-sm p-4 text-center d-flex justify-content-center align-items-center">
            ...
            <form method="POST" action="postCrearMueble.php" class="needs-validation w-75" novalidate>
                <div class="mb-3">
                    ...
                    <input id="nombre" name="nombre" type="text" class="form-control" placeholder="Ej: Mesa de comedor"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input id="peso" name="peso" type="number" step="0.01" class="form-control" placeholder="Ej: 12.5"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input id="ancho" name="ancho" type="number" step="0.01" class="form-control" placeholder="Ej: 1.20"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input id="largo" name="largo" type="number" step="0.01" class="form-control" placeholder="Ej: 2.00"
                        required>
                ...
                <div class="mb-3">
                    ...
                    <input id="alto" name="alto" type="number" step="0.01" class="form-control" placeholder="Ej: 0.75"
                        required>
